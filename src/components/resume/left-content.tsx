  ...
  return (
    <section className="flex flex-col gap-4 border-b p-4 sm:border-r sm:border-b-0">
      ...
      <div>
        ...
        <div className="text-sm">
          <p>
            ...
            <span className="font-semibold">JavaScript</span>. Skilled in building scalable, performant web
            applications with over <span className="font-semibold">6</span> years of hands-on experience using{' '}
            <span className="font-semibold">React.js</span> and <span className="font-semibold">Node.js</span>
            . Strong background in frontend, UI/UX decision-making, and modern development practices.
          </p>
        </div>
      </div>
      <div>
      ...
      <div>
        ...
        <p>
          HTML, CSS, Git, Docker, JavaScript, TypeScript, React, React Native, Tailwind, Next.js, and Node.js
        </p>
      </div>
    </section>
  )
